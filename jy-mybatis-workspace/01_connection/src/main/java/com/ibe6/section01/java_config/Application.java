package com.ibe6.section01.java_config;
...
public class Application {
    public static void main(String[] args) {
        ...
        String driver = "com.mysql.cj.jdbc.Driver"; // mysql-connection-j 라이브러리 필요
        ...
        /*
            ...
            3. new Environment(환경정보이름, 트랜잭션매니저종류결정, 커넥션풀사용여부); 로 생성
                ...
                3) 커넥션 풀 사용여부
                    ...
                    - UnPooledDataSource  : Connection Pool 미사용
...
//        configuration.setJdbcTypeForNull();
        ...
        /*
            ...
            2. 사용자의 요청시마다 생성하고 요청 처리가 완료되면 close 하는걸 권장
            3. SqlSessionFactory객체.openSession(autocommit활성화여부) 로 생성 => 수동저장 권하므로 false로
         */
