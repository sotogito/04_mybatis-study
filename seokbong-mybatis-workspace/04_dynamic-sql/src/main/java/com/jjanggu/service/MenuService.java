package com.jjanggu.service;

import com.jjanggu.dao.MenuMapper;
...
import static com.jjanggu.common.Template.getSqlSession;
...
public class MenuService {
    ...
    public int deleteMenu(List<Integer> deleteMenuCodes) {
        ...
        //int result = menuMapper.deleteMenu(deleteMenuCode); // List를 곧바로 전달하는 case
